...
OCV_C = readtable('40_OCV charge.csv', 'Delimiter', ';', 'DecimalSeparator', ',');
OCV_D = readtable('40_OCV discharge.csv', 'Delimiter', ';', 'DecimalSeparator', ',');
...
writematrix(M, '40_OCV.csv', 'Delimiter', ';');
